...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, location: String, sort: YelpSortMode?, categories: [String]?, openNow: Bool?, completion: @escaping ([Business]?, Error?) -> Void) -> Void {
        _ = YelpClient.sharedInstance.searchWithTerm(term, location: location, sort: sort, categories: categories, openNow: openNow, completion: completion)
    }
}
