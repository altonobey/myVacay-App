...
class HomeViewController: UIViewController {
    ...
    @IBAction func imageButtonTapped(_ sender: UIButton) {
        ...
        imageView.image = UIImage(named: "wonder\(currentImageNumber).png")!
    ...
    @objc func changeImage() {
        ...
        if previousImageNumber == numberOfImages {
            ...
            previousImageNumber = 1
            imageView.image = UIImage(named: "wonder1.png")!
            ...
            imageView.image = UIImage(named: "wonder\(previousImageNumber).png")!
